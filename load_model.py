"""
Script for loading a model into the cache for the first time.
Call: sbatch --gpus=rtx_4090:1 --mem-per-cpu=8G --wrap="python3 sft/load_model.py --model_name google/gemma-2b-it"
"""
import os
import torch
