...
from trl import SFTTrainer, DataCollatorForCompletionOnlyLM, PPOTrainer, DPOTrainer
...
def make_data_module(tokenizer: transformers.PreTrainedTokenizer, args) -> Dict:
    ...
    if args.do_train:
        train_dataset = dataset['train'] if not isinstance(dataset, Dataset) else dataset
